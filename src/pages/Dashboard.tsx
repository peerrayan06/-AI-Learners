...
import { Calendar, User, LogOut, Check, Edit2, TrendingUp } from 'lucide-react';
        ...
        <div className="md:col-span-6 glass-card p-8 rounded-2xl flex flex-col justify-between group">
          <div>
            <div className="flex justify-between items-start mb-6">
              ...
              <span className="px-3 py-1 rounded-full bg-secondary/10 text-secondary text-xs font-mono uppercase tracking-widest border border-secondary/20">Active</span>
            </div>
